	...
	<div class="container">
		...
		<div class="grid-container">
			...
			<div class="grid-item bloqueRestaurante">
				...
				<p class="p-4 my-lg-5">La gastronomía peruana es símbolo de orgullo para cada uno de sus habitantes. Es una de las más extensas y exquisitas del mundo que sin duda deleitan el paladar de sus afortunados comensales.</p>
